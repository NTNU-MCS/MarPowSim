...
#define S_FUNCTION_NAME IdealNozzlePTF
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define SOURCEFILES "__SFB__GetIdealNozzleFlow.c__SFB__GetThdynCombGasZach.c__SFB__GetCompCombGas_rtwutil.c__SFB__rt_nonfinite.c__SFB__rtGetNaN.c__SFB__rtGetInf.c"
#define PANELINDEX           6
...
extern void IdealNozzlePTF_Outputs_wrapper(const real_T *A_eff,
                          const real_T *pu,
                          const real_T *Tu,
                          const real_T *Fu,
                          const real_T *pd,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    IdealNozzlePTF_Outputs_wrapper(A_eff, pu, Tu, Fu, pd, Td, Fd, dmu, deu, dmbu, dmd, ded, dmbd, fs, p_width0);
}
