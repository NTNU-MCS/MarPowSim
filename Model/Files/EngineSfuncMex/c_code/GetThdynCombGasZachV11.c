/*
 * File: GetThdynCombGasZachV11.c
 *
 * MATLAB Coder version            : 2.7
 * C/C++ source code generated on  : 11-Sep-2015 10:06:56
 */
...
#include "GetThdynCombGasZachV11.h"
 ...
 * Return Type  : void
 */
void c_GetThdynCombGasZachV1(double P, double T, double F, double fs, double *R,
  double *h, double *s, double *u, double *RF, double *RP, double *RT, double
...
/*
 * File trailer for GetThdynCombGasZachV11.c
 *
 * [EOF]
 */
