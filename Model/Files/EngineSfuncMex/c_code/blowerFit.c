...
#define S_FUNCTION_NAME blowerFit
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Input Port  3 */
#define IN_PORT_3_NAME      mDotBlower
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T   *mDotBlower  = (const real_T*) ssGetInputPortSignal(S,3);
    ...
    blowerFit_Outputs_wrapper(pTF_u, pTF_d, blowerRun, mDotBlower, dmEmb_u, dmEmb_d, powBlower, effBlower, p_width0, fs, p_width1);
}
