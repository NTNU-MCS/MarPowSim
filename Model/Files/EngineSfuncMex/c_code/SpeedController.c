...
extern void SpeedController_Outputs_wrapper(const real_T *SP,
                          const real_T *MV,
                          real_T *u ,
			   const real_T *xC,
...
extern void SpeedController_Derivatives_wrapper(const real_T *SP,
                          const real_T *MV,
                          const real_T *uSat,
                          const real_T *u,
                          real_T *dx ,
...
#define MDL_INITIALIZE_CONDITIONS
 ...
 static void mdlInitializeConditions(SimStruct *S)
 {
   ...
   real_T *xC   = ssGetContStates(S);
    ...
    xC[0] = (*mxGetPr(ssGetSFcnParam(S, 7)));
    xC[1] =  0;
 }
...
{
    const real_T   *SP  = (const real_T*) ssGetInputPortSignal(S,1);
    const real_T   *MV  = (const real_T*) ssGetInputPortSignal(S,0);
    ...
    const real_T  *Kb  = (const real_T *)mxGetData(PARAM_DEF4(S));
    const real_T  *uMax  = (const real_T *)mxGetData(PARAM_DEF5(S));
    const real_T  *uMin  = (const real_T *)mxGetData(PARAM_DEF6(S));
    const real_T  *u0  = (const real_T *)mxGetData(PARAM_DEF7(S));

    SpeedController_Outputs_wrapper(SP, MV, u, xC, Kp, p_width0, Td, p_width1, N, p_width2, Ti, p_width3, Kb, p_width4, uMax, p_width5, uMin, p_width6, u0, p_width7);
}
...
/* Function: mdlDerivatives =================================================
  ...
  static void mdlDerivatives(SimStruct *S)
  {
    const real_T   *SP  = (const real_T*) ssGetInputPortSignal(S,1);
    const real_T   *MV  = (const real_T*) ssGetInputPortSignal(S,0);
    const real_T   *uSat  = (const real_T*) ssGetInputPortSignal(S,2);
    real_T         *dx  = ssGetdX(S);
    real_T         *xC  = ssGetContStates(S);
    real_T        *u  = (real_T *) ssGetOutputPortRealSignal(S,0);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    ...
    SpeedController_Derivatives_wrapper(SP, MV, uSat, u,dx,  xC, Kp, p_width0, Td, p_width1, N, p_width2, Ti, p_width3, Kb, p_width4, uMax, p_width5, uMin, p_width6, u0, p_width7);
}
