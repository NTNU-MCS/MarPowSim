...
extern "C" {
  ...
  extern void GetThdynCombGasZach(double P, double T, double F, double *R,
    double *h, double *s, double *u, double *RF, double *RP, double *RT, double *
    uF, double *uP, double *uT, double *Cp, double *Cv, double *K);
...
/*
 * File trailer for GetThdynCombGasZach.h
 *
 * [EOF]
 */
